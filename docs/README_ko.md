...
[릴리스 페이지](https://github.com/clash-orbit/clash-orbit/releases)에서 사용 중인 플랫폼에 맞는 설치 프로그램을 다운로드하세요.<br>
...
| 채널        | 설명                                                                                 | 링크                                                                                   |
| :---------- | :----------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------- |
| Stable      | 안정 릴리스. 신뢰성이 높아 일상 사용에 적합합니다.                                   | [Release](https://github.com/clash-orbit/clash-orbit/releases)                 |
| Alpha (EOL) | 퍼블리시 파이프라인 검증에 사용되었던 구 테스트 채널입니다.                          | [Alpha](https://github.com/clash-orbit/clash-orbit/releases/tag/alpha)         |
| AutoBuild   | 롤링 빌드 채널. 테스트와 피드백 용도로 권장되며, 실험적인 변경이 포함될 수 있습니다. | [AutoBuild](https://github.com/clash-orbit/clash-orbit/releases/tag/autobuild) |
...
[Clash Orbit 개발 후원](https://github.com/clash-orbit)
...
Clash Orbit는 다음 프로젝트에 기반하거나 영향을 받았습니다:
