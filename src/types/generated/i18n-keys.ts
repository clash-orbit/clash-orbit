...
export const translationKeys = [
  ...
  'home.components.systemInfo.fields.orbitVersion',
  ...
  'settings.components.orbit.basic.title',
  'settings.components.orbit.basic.actions.browse',
  'settings.components.orbit.basic.trayOptions.showMainWindow',
  'settings.components.orbit.basic.trayOptions.showTrayMenu',
  'settings.components.orbit.basic.trayOptions.disable',
  'settings.components.orbit.basic.fields.language',
  'settings.components.orbit.basic.fields.themeMode',
  'settings.components.orbit.basic.fields.trayClickEvent',
  'settings.components.orbit.basic.fields.copyEnvType',
  'settings.components.orbit.basic.fields.startPage',
  'settings.components.orbit.basic.fields.startupScript',
  'settings.components.orbit.basic.fields.themeSetting',
  'settings.components.orbit.basic.fields.layoutSetting',
  'settings.components.orbit.basic.fields.misc',
  'settings.components.orbit.basic.fields.hotkeySetting',
  'settings.components.orbit.advanced.title',
  'settings.components.orbit.advanced.tooltips.backupInfo',
  'settings.components.orbit.advanced.tooltips.openConfDir',
  'settings.components.orbit.advanced.tooltips.liteMode',
  'settings.components.orbit.advanced.actions.copyVersion',
  ...
  'settings.components.orbit.advanced.fields.backupSetting',
  'settings.components.orbit.advanced.fields.runtimeConfig',
  'settings.components.orbit.advanced.fields.openConfDir',
  'settings.components.orbit.advanced.fields.openCoreDir',
  'settings.components.orbit.advanced.fields.openLogsDir',
  'settings.components.orbit.advanced.fields.checkUpdates',
  'settings.components.orbit.advanced.fields.openDevTools',
  'settings.components.orbit.advanced.fields.liteModeSettings',
  'settings.components.orbit.advanced.fields.exit',
  'settings.components.orbit.advanced.fields.exportDiagnostics',
  'settings.components.orbit.advanced.fields.orbitVersion',
  'settings.components.orbit.theme.title',
  'settings.components.orbit.theme.fields.primaryColor',
  'settings.components.orbit.theme.fields.secondaryColor',
  'settings.components.orbit.theme.fields.primaryText',
  'settings.components.orbit.theme.fields.secondaryText',
  'settings.components.orbit.theme.fields.infoColor',
  'settings.components.orbit.theme.fields.warningColor',
  'settings.components.orbit.theme.fields.errorColor',
  'settings.components.orbit.theme.fields.successColor',
  'settings.components.orbit.theme.fields.fontFamily',
  'settings.components.orbit.theme.fields.cssInjection',
  'settings.components.orbit.theme.actions.editCss',
  'settings.components.orbit.theme.dialogs.editCssTitle',
  'settings.components.orbit.layout.title',
  'settings.components.orbit.layout.fields.preferSystemTitlebar',
  'settings.components.orbit.layout.fields.trafficGraph',
  'settings.components.orbit.layout.fields.memoryUsage',
  'settings.components.orbit.layout.fields.proxyGroupIcon',
  'settings.components.orbit.layout.fields.toastPosition',
  'settings.components.orbit.layout.fields.hoverNavigator',
  'settings.components.orbit.layout.fields.hoverNavigatorDelay',
  'settings.components.orbit.layout.fields.navIcon',
  'settings.components.orbit.layout.fields.collapseNavBar',
  'settings.components.orbit.layout.fields.trayIcon',
  ...
  'settings.components.orbit.layout.fields.tunTrayIcon',
  'settings.components.orbit.layout.fields.enableTrayIcon',
  ...
  'settings.components.orbit.layout.options.icon.colorful',
  'settings.components.orbit.layout.options.icon.disable',
